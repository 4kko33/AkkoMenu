...
local Library = { 
    ...
    FontSize = 12,  -- AUMENTEI PARA 14 (antes era 12)
    ...
    do
        ...
        Library.Window = function(Self, Params)
            ...
            local Items = { } do 
                ...
                -- JANELA MAIOR: 1000x700
                Items["Outline"] = Library:Create("Frame", {
                    Name = "\0",
                    Parent = Library.Holder.Instance,
                    AnchorPoint = Vector2.new(0.5, 0.5),
                    Position = UDim2.new(0.5, 0, 0.5, 0),
                    Size = UDim2.new(0, 1000, 0, 700),   -- <-- TAMANHO AUMENTADO
                    BorderSizePixel = 0,
                    BackgroundColor3 = Library.Theme["Border"]
                }):AddToTheme({BackgroundColor3 = 'Border'})
        ...
        Library.Page = function(Self, Params)
            ...
            local Items = { } do 
                ...
                -- TRÊS COLUNAS: Left, Middle, Right
                Items["LeftColumn"] = Library:Create("ScrollingFrame", {
                    ...
                    BackgroundTransparency = 1,
                    Size = UDim2.new(1/3, 0, 1, 0),  -- 1/3 da largura
                    BorderSizePixel = 0,
                ...
                -- Atualiza o mapeamento para 3 colunas
        ...
        Library.Section = function(Self, Params)
            ...
            local Section = {
                ...
                Side = Params.Side or Params.side or 1,  -- 1, 2 ou 3
    ...
    -- fixed: use 10^Decimals multiplier instead of 1/Float division
